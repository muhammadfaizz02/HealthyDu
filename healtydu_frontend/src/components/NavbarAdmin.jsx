    ...
    return <>
        <div className="w-full p-2 gap-2 justify-between items-center text-md lg:text-lg 2xl:text-lg bg-white hidden md:flex lg:flex 2xl:flex">
            ...
            <div className="flex justify-between items-center font-semibold gap-4 md:gap-6 lg:gap-8 2xl:gap-8 text-sm md:text-md lg:text-md 2xl:text-lg ">
                <a href="/admin" className={currentPath === '/admin' ? 'text-sky-500 font-extrabold' : ''}>Beranda</a>
                <a href="/admin/food" className={currentPath === '/admin/food' ? 'text-sky-500 font-extrabold' : ''}>Makanan</a>
                <a href="/admin/recipe" className={currentPath === '/admin/recipe' ? 'text-sky-500 font-extrabold' : ''}>Resep</a>
                <a href="/admin/course" className={currentPath === '/admin/course' ? 'text-sky-500 font-extrabold' : ''}>Kursus</a>
                <a href="/user" className={currentPath === '/user' ? 'text-sky-500 font-extrabold' : ''}>User</a>
                <a href="/program" className={currentPath === '/program' ? 'text-sky-500 font-extrabold' : ''}>Program</a>
                <a href="/exercise" className={currentPath === '/exercise' ? 'text-sky-500 font-extrabold' : ''}>Latihan</a>
                <a href="/category" className={currentPath === '/category' ? 'text-sky-500 font-extrabold' : ''}>Kategori</a>
            </div>
                        ...
                        <div>
                            ...
                            <div className="text-sm md:text-md lg:text-md 2xl:text-lg mt-6">
                                <div className="flex justify-start items-start gap-4 mb-3">
                                    ...
                                    <a className="" href="/admin">Beranda</a>
                                </div>
                                <div className="flex justify-start items-start gap-4 mb-3">
                                    <img className="w-6 " src={Food} alt="" />
                                    <a className="" href="/admin/food">Makanan</a>
                                </div>
                                <div className="flex justify-start items-start gap-4 mb-3">
                                    <img className="w-6 " src={Recipe} alt="" />
                                    <a className="" href="/admin/recipe">Resep</a>
                                </div>

                                <div className="flex justify-start items-start gap-4 mb-3">
                                    <img className="w-6 " src={Fitness} alt="" />
                                    <a className="" href="/admin/course">Kursus</a>
                                </div>

                                <div className="flex justify-start items-start gap-4 mb-3">
                                    <img className="w-6 " src={Fitness} alt="" />
                                    <a className="" href="/user">User</a>
                                </div>
                                <div className="flex justify-start items-start gap-4 mb-3">
                                    <img className="w-6 " src={Fitness} alt="" />
                                    <a className="" href="/program">Program</a>
                                </div>
                            </div>
                        </div>
